...
class SDG(BaseSDG):
    def __init__(self, stage_url: str, dome_texture_urls: list,
                 ...
                 save_path=None) -> None:
        # super().__init__(writer_type=rep.BasicWriter, save_path=save_path)
        ...
        self._writer.initialize(output_dir=data_save_dir,
                          rgb=True,                         # optional
                          semantic_segmentation=True,        # required
                          colorize_semantic_segmentation=False  # False = id map, True = colored PNG
            )
